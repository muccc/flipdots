...
matrix = FlipdotMatrix(
	udpHostsAndPorts = [
		("2001:7f0:3003:235e:ba27:ebff:feb9:db12",2323),
...
def minipage(msg):
	return "<html><head><title>FlipdotDebugPage</title></head><body><h3>"+msg+"</h3><ul><li><a href='/reset'>reset all</a></li><li><a href='/white'>white</a></li><li><a href='/black'>black</a></li><li><a href='/chess'>chess</a></li></ul></body></html>"
